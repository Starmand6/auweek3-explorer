# Alchemy University Eth Dev Bootcamp Week 3 Project - Ethereum Block Explorer

Week 3 focused on using Ethers.js to read information from and write to the blockchain. The Week 3 project was to create a very simple block explorer.

These types of projects are very tedious for me, because I am absolutely not interested in the front end of things, especially using React. Gonna get a bumper sticker that says, "I'd rather be writing smart contracts."

## Functionality and Features Added for the Project

-   Block details for current block (hash, timestamp, gas limit, gas used)
-   Show the previous five blocks in a list
-   Show the last five transaction hashes for the latest block
-   Account section that shows ETH balance, NFTs owned, and for any wallet address entered
-   NFT section: shows name, symbol, total supply, and floor price for any NFT

## Learnings

-   Did I mention I don't like messing with front ends?
-   There's a pretty big need to decentralize block explorers, so people who can't directly access nodes can verify information and be confident in result.

Screenshot of App (with one of the Kraken Exchange wallets as an example address):

![Alt text](src/ExplorerScreenshot.png)

# Original Ethereum Block Explorer Project Instructions from Alchemy
